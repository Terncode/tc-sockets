	...
	describe(name, () => {
		...
		describe('binary encoding', () => {
			...
			beforeEach(() => {
				actions = {};
				remote = {};
				sender = createPacketHandler(server, client, { development: true }, console.log, codeGenHandler);
				receiver = createPacketHandler(client, server, { development: true }, console.log, codeGenHandler);
			...
			it('batch', () => {
				...
				//console.log(remote.foo1.toString());
