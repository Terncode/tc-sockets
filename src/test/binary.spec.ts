	...
	describe(name, () => {
		...
		describe('binary encoding', () => {
			...
			beforeEach(() => {
				actions = {};
				remote = {};
				const sender = createPacketHandler(server, client, { development: true }, console.log, codeGenHandler);
				const receiver = createPacketHandler(client, server, { development: true }, console.log, codeGenHandler);
